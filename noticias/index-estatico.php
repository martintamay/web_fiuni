	...
	<body data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
		...
		<div id="main" class="main">
				...
				<div class="container-fluid">
					...
					<div id="nav-superior" class="collapse navbar-collapse">
						<ul class="nav navbar-nav navbar-right">
							<li><a href="javascript:custom.js;" onclick='abrir("institucional")'>Institucional</a></li>
							<li><a href="javascript:custom.js;" onclick='abrir("departamentos")'>Departamentos</a></li>
							<li><a href="javascript:custom.js;" onclick='abrir("direccion")'>Dirección de Carreras</a></li>
			...
			<section id="noticias">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 text-center">
							<div class="section-title">
								<h1 class="heading bold rojo">Últimas Noticias</h1>
								<hr>
							</div>
						</div>
					</div>
					<div class="row panel panel-default">		
						<div class="row">
							<div class="col-md-9 col-sm-12">
								...
								<a href="#" class="btn btn-danger">Descargar Formulario</a>
							</div>
				...
				<div class="container nav-noticias" style="text-align: center;">
					<a class="btn btn-danger" onClick="noticiasAnt();">Anterior</a>
					<a class="btn btn-danger" onClick="noticiasSig();">Siguiente</a>	
				</div>			
			</section>
