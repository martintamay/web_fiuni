...
<html lang="es">
	...
	<body data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
		...
		<div id="main" class="main">
				...
				<div class="container-fluid">
					...
					<div id="nav-superior" class="collapse navbar-collapse">
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="javascript:custom.js;" onclick='abrir("cpa.html")'>CPA</a></li>
							<li><a href="javascript:custom.js;" onclick='abrir("laboratorios.html")'>Laboratorios</a></li>
							<li><a href="javascript:custom.js;" onclick='abrir("acreditaciones.html")'>Acreditaciones</a></li>
			...
			<section id="pdf-portfolio">
				<div class="container">
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="section-title">
								<h1 class="heading bold rojo">Descarga Documentos</h1>
								<p>
									Obtén todos los documentos que necesites con solo 1 clic.
								</p>
								<hr>								
							</div>
						</div>
						...
						<div class="col-lg-12">
						    <div class="portfolioFilter clearfix">
						    	...
						    	<a href="#" data-filter=".cpa">CPA</a>
						    	<a href="#" data-filter=".academico">Academico</a>
						    	<a href="#" data-filter=".programa-de-estudios">Programa de Estudios</a>
						    	<a href="#" data-filter=".horarios">Horarios</a>
						    </div>
      					</div>
      					<div class="col-md-12">
						    <div class="portfolioContainer">
						      <a href="../documentos/documento1.pdf" target="_blank" class="item cpa">
						      ...
						      <a href="../documentos/documento1.pdf" target="_blank" class="item academico">
						        <img src="../images/pdf.png" alt="pdf">
						      	<apan>academico</span>
						      </a>
						      <a href="../documentos/documento1.pdf" target="_blank" class="item horarios cpa">
						        <img src="../images/pdf.png" alt="pdf">
						      	<apan>horarios cpa</span>
						      </a>
						      <a href="../documentos/documento1.pdf" target="_blank" class="item programa-de-estudios">
						        <img src="../images/pdf.png" alt="pdf">
						      	<apan>programa-de-estudios</span>
						      </a>
						      <a href="../documentos/documento1.pdf" target="_blank" class="item cpa programa-de-estudios">
						        <img src="../images/pdf.png" alt="pdf">
						      	<apan>cpa programa-de-estudios</span>
						      </a>
						      <a href="../documentos/documento1.pdf" target="_blank" class="item academico cpa">
						        <img src="../images/pdf.png" alt="pdf">
						      	<apan>academico cpa</span>
						      </a>
				   			</div>
				    	</div>
					</div>
